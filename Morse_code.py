# -*- coding: utf-8 -*-
"""
Created on Tue May  7 20:51:44 2024

@author: Shraddha
"""

import cv2
import time #to see frame rate
...
while True:
    ...
    if results.multi_face_landmarks:
        for faceLm in results.multi_face_landmarks:
            mp_draw.draw_landmarks(scaled, faceLm, mp_facemesh.FACEMESH_TESSELATION, draw_spec, draw_spec)
